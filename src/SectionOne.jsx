...
export function SectionOne() {
    return (
        <section className="first flex xl:w-[970px] md:h-[468px] bg-white lg:ml-[30px] my-5">
                ...
                <h1 className="xl:text-[48px] font-bold pb-[18px]">
                    ...
                    <p className="text-[10px] md:text-[16px] text-[#767676]">Lorem ipsum dolor sit amet, consectetur adipiscing
                        elit.
                        Et,
                        volutpat feugiat
                        placerat lobortis.
